...
public class Persistence {
    ...
    // Persistence objects.
    private final static String PACKAGES = "com.shopify.shoplite.entities";

    // Connection properties.
    private final static Path DB_PATH = Paths.get(System.getProperty("user.dir"), "db", "shoplite-dev");
